...
#define UART_ISR          USART_RXC_vect
#define DATA_REG          UDR
#define STATUS_A          UCSRA
#define STATUS_B          UCSRB
#define BAUD_LOW          UBRRL
#define BAUD_HIGH         UBRRH
#define RECV_COMPLETE     RXC
#define DATA_REG_EMPT     UDRE
#define RECEIVER_EN       RXEN
#define TRANSMITTER_EN    TXEN
